import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, Suspense, nextTick, mergeProps, provide, watch, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { n as createHooks, o as getContext, c as createError$1, q as toRouteMatcher, v as createRouter, w as defu, x as sanitizeStatusCode, y as executeAsync, z as getRequestHeaders, d as destr, A as klona, B as parse$1, C as getRequestHeader, D as isEqual$1, E as setCookie, F as getCookie, G as deleteCookie, H as defuFn } from '../_/nitro.mjs';
...
const _routes = [
  ...
  {
    name: "addOrders___en-US",
    path: "/en-US/addOrders",
    component: () => import('./addOrders.vue.mjs')
  },
  {
    name: "addOrders___zh-CN",
    path: "/zh-CN/addOrders",
    component: () => import('./addOrders.vue.mjs')
  },
  {
    name: "addOrders___zh-TW",
    path: "/addOrders",
    component: () => import('./addOrders.vue.mjs')
  },
  {
    name: "checkUsers___en-US",
    path: "/en-US/checkUsers",
    component: () => import('./checkUsers.vue.mjs')
  },
  {
    name: "checkUsers___zh-CN",
    path: "/zh-CN/checkUsers",
    component: () => import('./checkUsers.vue.mjs')
  },
  {
    name: "checkUsers___zh-TW",
    path: "/checkUsers",
    component: () => import('./checkUsers.vue.mjs')
  },
  {
    name: "approveRefund___en-US",
    path: "/en-US/approveRefund",
    component: () => import('./approveRefund.vue.mjs')
  },
  {
    name: "approveRefund___zh-CN",
    path: "/zh-CN/approveRefund",
    component: () => import('./approveRefund.vue.mjs')
  },
  {
    name: "approveRefund___zh-TW",
    path: "/approveRefund",
    component: () => import('./approveRefund.vue.mjs')
  },
  {
    name: "offDaySetting___en-US",
    path: "/en-US/offDaySetting",
    component: () => import('./offDaySetting.vue.mjs')
  },
  {
    name: "offDaySetting___zh-CN",
    path: "/zh-CN/offDaySetting",
    component: () => import('./offDaySetting.vue.mjs')
  },
  {
    name: "offDaySetting___zh-TW",
    path: "/offDaySetting",
    component: () => import('./offDaySetting.vue.mjs')
  }
];
...
const localeLoaders = {
  "en-US": [
    {
      key: "locale_en_45US_46json_1ba1ab34",
      load: () => import(
        './en-US.json.mjs'
        /* webpackChunkName: "locale_en_45US_46json_1ba1ab34" */
      ),
      cache: true
    }
  ],
  "zh-CN": [
    {
      key: "locale_zh_45CN_46json_eb6e8069",
      load: () => import(
        './zh-CN.json.mjs'
        /* webpackChunkName: "locale_zh_45CN_46json_eb6e8069" */
      ),
      cache: true
    }
  ],
  "zh-TW": [
    {
      key: "locale_zh_45TW_46json_b9c5b63a",
      load: () => import(
        './zh-TW.json.mjs'
        /* webpackChunkName: "locale_zh_45TW_46json_b9c5b63a" */
      ),
      cache: true
    }
  ]
...
const normalizedLocales = [
  {
    ...
    files: [
      {
        path: "E:/line_miniApp/demo/LWM/test6/i18n/locales/en-US.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "E:/line_miniApp/demo/LWM/test6/i18n/locales/zh-CN.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "E:/line_miniApp/demo/LWM/test6/i18n/locales/zh-TW.json",
        cache: void 0
      }
    ]
  }
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, useI18n as e, useLocalePath as f, useAppConfig as g, hasProtocol as h, asyncDataDefaults as i, joinURL as j, createError as k, navigateTo as n, parseQuery as p, resolveRouteObject$1 as r, server as s, tryUseNuxtApp as t, useRouter as u, withTrailingSlash as w };
